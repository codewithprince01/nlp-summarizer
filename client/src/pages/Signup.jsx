      ...
      >
        <div className="text-center">
          ...
          <p className="text-blue-100 text-lg mb-8">
            Create your account and experience AI-powered summarization
          </p>

          <motion.img
            src="https://img.icons8.com/3d-fluency/500/artificial-intelligence.png"
            alt="AI Illustration"
            className="w-[400px] mx-auto rounded-3xl shadow-2xl border border-white/20"
            animate={{ y: [0, -20, 0] }}
            transition={{
              duration: 3,
              repeat: Infinity,
      ...
      >
        <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-10">
          ...
          <p className="text-center text-gray-500 mb-6">
            Join us and simplify your content with AI ⚡
          </p>
